            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (string.IsNullOrEmpty(returnUrl) || returnUrl == Url.Content("~/"))
                    {
                        ...
                        {
                            returnUrl = Url.Page("/Admin/Home/Dashboard", new { area = "Admin" });
                        }
                        else if (User.IsInRole("Therapist"))
                        {
                            returnUrl = Url.Page("/Therapist/Home/Dashboard", new { area = "Therapist" });
                        }
                        else if (User.IsInRole("CustomerService"))
                        {
                            returnUrl = Url.Page("/CustomerService/Home/Dashboard", new { area = "CustomerService" });
                        }
                    }
